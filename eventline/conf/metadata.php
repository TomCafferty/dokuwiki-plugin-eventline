...
$meta['detailInterval'] = array('multichoice','_choices' => 
array('MILLISECOND', 'SECOND', 'MINUTE', 'HOUR', 'DAY', 'WEEK', 'MONTH', 'YEAR', 'DECADE', 'CENTURY', 'MILLENNIUM', 'EPOCH', 'ERA')); 
$meta['overInterval'] = array('multichoice','_choices' => 
array('MILLISECOND', 'SECOND', 'MINUTE', 'HOUR', 'DAY', 'WEEK', 'MONTH', 'YEAR', 'DECADE', 'CENTURY', 'MILLENNIUM', 'EPOCH', 'ERA')); 
